...
public class DemoApplication implements CommandLineRunner {
    ...
    private void listarEmpleados() {
        ...
        empleados.forEach(e -> logger.info(
                "ID: {}, RUT: {}, Nombre: {}, Fecha de Nacimiento: {}, Sexo: {}, Grado: {}, Categoria: {}, Domicilio: {}",
                e.getId(), e.getRut(), e.getNombre(), e.getFechaNacimiento(), e.getSexo(), e.getGrado(),
                e.getCategoria(), e.getDomicilio()));
    }
}